...
//
//
//     private void SetupControllerContext(Claim[] claims)
//     {
...
//
//         // Act
//         var result = _controller.UpdateProficiency("test", proficiencyLevel) as OkResult;
//
//         // Assert
//         Assert.IsNotNull(result);
//         Assert.AreEqual(200, result.StatusCode);
...
//
//         // Act
//         var result = _controller.UpdateProficiency("test", proficiencyLevel) as BadRequestResult;
//
//         // Assert
//         Assert.IsNotNull(result);
//         Assert.AreEqual(400, result.StatusCode);
...
//
//         // Act
//         var result = _controller.UpdateProficiency("test", proficiencyLevel) as BadRequestObjectResult;
//
//         // Assert
//         Assert.IsNotNull(result);
//         Assert.AreEqual(400, result.StatusCode);
