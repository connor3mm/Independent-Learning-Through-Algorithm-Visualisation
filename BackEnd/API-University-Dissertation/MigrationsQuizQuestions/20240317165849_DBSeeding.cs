    ...
    public partial class DBSeeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "What is the best case time complexity of bubble sort?", 1 },
                    ...
                    { 9, "What is the space complexity of insertion sort?", 1 },
                    ...
                    { 14, "What is the worst case time complexity of quick sort?", 1 },
                    ...
                    { 19, "What does the ascending motion of bubbles in fizzy water symbolise in Bubble Sort?", 2 },
                    ...
                    { 23, "Merge Sort employs which technique to sort elements?", 2 },
                    ...
                    { 27, "In which data structure is binary search typically applied?", 3 },
                    { 28, "Which searching algorithm is based on the principle of repeatedly dividing the search interval in half?", 3 },
                    { 29, "What is the primary advantage of binary search over linear search?", 3 },
